...
def main():
    ...
    recommendation_agent = RecommendationAgent(
                                    os.path.join(os.path.join(folder_path, 'recommendation_objects/apriori_recommendations.json')),
                                    os.path.join(os.path.join(folder_path, 'recommendation_objects/popularity_recommendation.csv'))
                                )
